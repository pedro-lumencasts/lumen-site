# Hero v3 — Animated marquee

Source: 21st.dev · `hero-3.tsx` (`AnimatedMarqueeHero`). Full component source below.
Requires `framer-motion`.

## Lumen adaptation

Reframed as a **cinema marquee**: bulb strip along the top, headline igniting word by word,
...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  tagline, title, description, ctaText, images, className,
}) => {
  ...
  return (
    <section className={cn(
      ...
      <div className="z-10 flex flex-col items-center">
        <motion.div
          initial="hidden" animate="show" variants={FADE_IN_ANIMATION_VARIANTS}
